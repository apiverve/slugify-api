// Package slugify provides a Go client for the Slugify API.
//
// For more information, visit: https://apiverve.com/marketplace/slugify?utm_source=go&utm_medium=readme
package slugify
...
// Request contains the parameters for the Slugify API.
//
// Parameters:
//   - text (required): string - The text to convert to a slug
//   - separator: string - The separator character
//   - lowercase: boolean - Convert to lowercase (default: true)
type Request struct {
	Text string `json:"text"` // Required
	Separator string `json:"separator,omitempty"` // Optional
	Lowercase string `json:"lowercase,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Slugify API.
