...
const (
	baseURL        = "https://api.apiverve.com/v1/slugify"
	defaultTimeout = 30 * time.Second
)

// Client is the Slugify API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Slugify API client.
...
// Execute makes a request to the Slugify API with typed parameters.
//
