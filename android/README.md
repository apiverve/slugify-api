...
```gradle
dependencies {
    implementation 'com.github.apiverve:slugify-api:1.1.12'
}
```
...
```java
import com.apiverve.slugify.SlugifyAPIClient;
import com.apiverve.slugify.APIResponse;
import com.apiverve.slugify.APIException;

// Initialize the client
SlugifyAPIClient client = new SlugifyAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/slugify](https://docs.apiverve.com/ref/slugify)
...
- **Documentation:** [https://docs.apiverve.com/ref/slugify](https://docs.apiverve.com/ref/slugify)
- **Issues:** [GitHub Issues](https://github.com/apiverve/slugify-api/issues)
