...
namespace APIVerve.API.Slugify
{
    ...
    /// <summary>
    /// Client for the Slugify API
    /// </summary>
    public class SlugifyAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/slugify";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true } },
            { "separator", new ValidationRule { Type = "string", Required = false } },
            { "lowercase", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public SlugifyAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SlugifyAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SlugifyAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SlugifyQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SlugifyQueryOptions options)
        {
        ...
        public ResponseObj Execute(SlugifyQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SlugifyQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SlugifyQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SlugifyQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SlugifyQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SlugifyQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SlugifyQueryOptions options)
        {
