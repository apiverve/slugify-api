...
class slugifyWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/slugify');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"separator":{"type":"string","required":false,"default":"-"},"lowercase":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/slugify`);
        }
    }
